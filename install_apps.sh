...
echo "\t${YELLOW}Step 5: Installing dotfiles... ${RESET}\n"
./dotfiles/install.sh
...
echo "\t${YELLOW}Step 9: Installing Apps ...${RESET}\n"
sudo apt install tlp tlp-rdw postgresql postgresql-contrib htop kazam gufw python3-pip python3-dev curl gnupg

echo "\t${YELLOW}Step 10: Installing virtualenv ...${RESET}\n"
pip3 install virtualenv

echo "\t${YELLOW}Step 11: Installing Uget and Uget-Integrator ...${RESET}\n"
...
echo "\t${YELLOW}Step 12: Installing Etcher...${RESET}\n"
echo "deb https://deb.etcher.io stable etcher" | sudo tee /etc/apt/sources.list.d/balena-etcher.list
sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 379CE192D401AB61
sudo apt update
sudo apt install -y balena-etcher-electron

echo "\t${YELLOW}Step 13: Installing MPV...${RESET}\n"
...
echo "\t${YELLOW}Step 14: Installing node...${RESET}\n"
curl -sL https://deb.nodesource.com/setup_14.x | sudo -E bash -
sudo apt install -y nodejs

echo "\t${YELLOW}Step 15: Installing yarn...${RESET}\n"
curl -sS https://dl.yarnpkg.com/debian/pubkey.gpg | sudo apt-key add -
echo "deb https://dl.yarnpkg.com/debian/ stable main" | sudo tee /etc/apt/sources.list.d/yarn.list
sudo apt update
sudo apt install -y yarn

echo "\t${YELLOW}Step 16: Installing Brave...${RESET}\n"
curl -s https://brave-browser-apt-release.s3.brave.com/brave-core.asc | sudo apt-key --keyring /etc/apt/trusted.gpg.d/brave-browser-release.gpg add -
echo "deb [arch=amd64] https://brave-browser-apt-release.s3.brave.com/ stable main" | sudo tee /etc/apt/sources.list.d/brave-browser-release.list
sudo apt update
sudo apt install brave-browser

echo "\t${YELLOW}Step 17: Installing RabbitMQ...${RESET}\n"
...
echo "\t${YELLOW}Step 18: Restore Keyboard shortcuts... ${RESET}\n"
dconf load /org/gnome/desktop/wm/keybindings/ < ./dotfiles/keybindings.dconf

echo "\t${YELLOW}Step 19: Cleaning up...${RESET}\n"
