...
if [[ -n $SSH_CONNECTION ]]; then
  ...
  sshcolor='red';
  PROMPT='%{$fg[cyan]%}[%{$fg[$sshcolor]%}ssh:$sshsource%{$fg[cyan]%}]%{$fg[yellow]%}%{$fg[cyan]%}[%{$fg[$style]%}$sign%{$fg[cyan]%}]%{$fg[yellow]%}%{$fg[magenta]%}[%{$fg[yellow]%}%c%{$fg[magenta]%}]%{$fg[yellow]%}:➜%{$reset_color%}';
else
  # The prompt
...
RPROMPT='%{$fg[magenta]%}[${time}%{$fg[magenta]%}] %{$fg[magenta]%}$(git_prompt_info)%{$reset_color%}$(git_prompt_status)%{$reset_color%}$(git_prompt_ahead)%{$reset_color%}'
...
ZSH_THEME_GIT_PROMPT_PREFIX="ǁ %{$fg[red]%}"
